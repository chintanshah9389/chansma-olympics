...
export const GU = {
  ...
  mainSport: 'મુખ્ય રમત — વૈકલ્પિક (એક પસંદ કરો)',
  mainHintMale: 'વૈકલ્પિક — ફૂટબોલ અથવા પિકલબોલ',
  mainHintFemale: 'વૈકલ્પિક — પિકલબોલ (ફૂટબોલ ફક્ત પુરુષો માટે)',
  extraSports: 'વધારાની રમતો — મહત્તમ ૨ (કુલ ઓછામાં ઓછી ૧ રમત)',
  extraHint:
    'કેરમ, ચેસ, ટેબલ ટેનિસ, બેડમિન્ટન — ૨ સુધી પસંદ કરો. કુલ ઓછામાં ઓછી એક રમત જરૂરી છે.',
  ...
  errMinOneSport: 'ઓછામાં ઓછી એક રમત પસંદ કરો (મુખ્ય અથવા વધારાની)',
